...
export interface GalleryBlockSliceDefaultItem {
  ...
  media: prismic.LinkToMediaField
  /**
   * Embed url field in *GalleryBlock → Items*
   *
   * - **Field Type**: Link
   * - **Placeholder**: Lien vers une plateforme vidéo
   * - **API ID Path**: gallery_block.items[].embed_url
   * - **Documentation**: https://prismic.io/docs/core-concepts/link-content-relationship
   *
   */
  embed_url: prismic.LinkField
