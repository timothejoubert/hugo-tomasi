...
<script lang="ts">
import Vue from 'vue'
import IconCross from '~/assets/images/icons/close.svg?sprite'
...
export default Vue.extend({
    ...
    computed: {
        documentList(): ImageField[] {
            return this.$store.state.mediaViewerData.map((media: ImageField, _index: number) => {
                return media
            })
        },
